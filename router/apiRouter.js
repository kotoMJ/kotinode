...
exports.getApiRouter = function () {
    ...
    api_router.use(function (req, res, next) {
        ...
        res.header("Access-Control-Allow-Headers", "Access-Control-Allow-Headers,Access-Control-Allow-Origin, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, Accept, ApiToken, apitoken");
